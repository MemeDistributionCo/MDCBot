...
public interface Command {
	...
	/**
	 * Used to run a command. Should be called after
	 * {@link #called(CommandSet, MDCBot)} returns true.
	 * 
	 * @param s
	 *            CommandSet for this command
	 * @param b
	...
	/**
	 * Get all child commands of this command. Ex /duel *accept* @user, accept is
	 * the child.
	 * 
	 ...
	 *            The message event
	 * @param b
	 *            The bot parsing this command.
	 * @return Command or null
	 */
	public static CommandSet parseCommand(String message, MessageReceivedEvent e, MDCBot b) {
		if (message.startsWith(Command.COMMAND_PREFIX)) {
			...
			for (CommandLabel label : b.getCommandLabels()) {
